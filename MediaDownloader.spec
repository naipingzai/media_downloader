...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('/home/npznnz/Project/MediaDownloader/build/ffmpeg', '.'), ('/home/npznnz/Project/MediaDownloader/ui/gui/resources/styles.qss', 'ui/gui/resources'), ('/home/npznnz/Project/MediaDownloader/static/check.svg', 'static')],
